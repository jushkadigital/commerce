...
export type AdminInitializePaymentSessionType = z.infer<typeof AdminInitializePaymentSession>;
export declare const AdminInitializePaymentSession: z.ZodObject<{
