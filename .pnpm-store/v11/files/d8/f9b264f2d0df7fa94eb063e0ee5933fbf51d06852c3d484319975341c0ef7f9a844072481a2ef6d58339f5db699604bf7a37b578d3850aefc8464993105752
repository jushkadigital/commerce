...
export declare const AdminGetRbacRoleParams: z.ZodObject<{
    fields: z.ZodOptional<z.ZodString>;
    policies: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
}, z.core.$strip>;
export declare const AdminGetRbacRolesParamsFields: z.ZodObject<{
    ...
    parent_id: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
...
export type AdminGetRbacRolesParamsType = z.infer<typeof AdminGetRbacRolesParams>;
export declare const AdminGetRbacRolesParams: z.ZodObject<{
    [x: string]: any;
...
export declare const AdminCreateRbacRole: z.ZodObject<{
    name: z.ZodString;
...
export declare const AdminUpdateRbacRole: z.ZodObject<{
    name: z.ZodOptional<z.ZodString>;
    parent_id: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    metadata: z.ZodOptional<z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
}, z.core.$strict>;
export declare const AdminAddRolePoliciesType: z.ZodObject<{
    policies: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
export type AdminAddRolePoliciesType = z.infer<typeof AdminAddRolePoliciesType>;
export declare const AdminGetRoleUsersParamsFields: z.ZodObject<{
    user_id: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
}, z.core.$strip>;
export type AdminGetRoleUsersParamsType = z.infer<typeof AdminGetRoleUsersParams>;
export declare const AdminGetRoleUsersParams: z.ZodObject<{
    [x: string]: any;
    $and: z.ZodOptional<z.ZodLazy<z.ZodArray<z.ZodObject<{
        user_id: z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>;
    }, z.core.$strip>>>>;
...
export declare const AdminAssignRoleUsers: z.ZodObject<{
    users: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
export type AdminRemoveRoleUsersType = z.infer<typeof AdminRemoveRoleUsers>;
export declare const AdminRemoveRoleUsers: z.ZodObject<{
    users: z.ZodArray<z.ZodString>;
}, z.core.$strip>;
